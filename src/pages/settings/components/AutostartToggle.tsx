  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open Nexus-AI-Interview-Assistance when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "Nexus-AI-Interview-Assistance will launch automatically on system startup"
                : "Nexus-AI-Interview-Assistance will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
