...
const DEFAULT_MODELS: Model[] = [
  {
    ...
    description: "Google Gemini 2.5 Flash low-latency flagship",
  ...
  },
  {
    ...
    description: "Google Gemini 2.5 Pro advanced reasoning",
    modality: "text,image,audio",
    isAvailable: true,
  },
  {
    ...
    description: "Google Gemini 2.0 Flash real-time streaming",
    modality: "text,image,audio",
    isAvailable: true,
  },
  {
